...
namespace CSharp_XLS
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //ExcelDataReader.ReadData(@"C:\git\CSHARP\ConvertDataPath2Wex\Files\Example1\EAB_MultiER_105.xls");
            ExcelDataReader.ReadData(@"C:\git\CSHARP\ConvertDataPath2Wex\Files\Example1\EAB_MultiER_105.csv");
